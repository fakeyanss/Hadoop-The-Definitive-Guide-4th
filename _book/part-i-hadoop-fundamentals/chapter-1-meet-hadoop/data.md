...
<<<<<<< HEAD
We live in the data age. It’s not easy to [measure]( "测量") the total volume of data stored electronically, but an [IDC]("国际文献资料中心") estimate put the size of the “digital universe” at 4.4 [zettabytes ]("泽字节ZB")in 2013 and is forecasting a tenfold growth by 2020 to 44 zettabytes.[^1] A zettabyte is 1021 bytes, or [equivalently]("相等地") one thousand [exabytes]("艾字节EB"), one million [petabytes]("拍字节PB"), or one billion [terabytes]("太字节TB"). That’s more than one disk drive for every person in the world.
=======
...
>>>>>>> 08efbb1a348c46a8d040fb0d2c06e11c93eadc31
